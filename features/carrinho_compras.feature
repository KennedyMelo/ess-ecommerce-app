...
Ideia geral: O usuário tenta apertar no botão de efetuar o pagamento de um carrinho de compras vazio, mas é impedido pela não seleção de produtos.

Scenario: Carrinho de compras abandonado
Ideia geral: O usuário seleciona itens para o seu carrinho de compras, porém ele sai do site. Quando ele voltar o carrinho deve estar com os itens que ele selecionou anteriormente.
